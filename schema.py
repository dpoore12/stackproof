...
CATEGORY_SEAT_POINTS: dict[str, tuple[int, ...]] = {
    ...
    "recruiting": (10, 25, 50, 100, 250),
    "wiki": (1, 3, 5, 10, 25),
    "productivity_suite": (1, 5, 10, 25, 50),
    ...
    "learning_management": (10, 50, 100, 500, 1000),
    "field_service_management": (1, 5, 10, 20, 50),
    "property_management": (1, 10, 50, 150, 500),
    "legal_practice_management": (1, 3, 5, 10, 25),
    "digital_signage": (1, 5, 10, 25, 50),
    "fleet_management": (1, 5, 10, 25, 50),
    "gym_management": (25, 50, 100, 200, 400),
    ...
    "vacation_rental_management": (1, 2, 5, 10, 25),
    "photography_studio_management": (1, 3, 5, 10, 25),
    "interior_design_management": (1, 3, 5, 10, 25),
    "wedding_event_planning": (1, 3, 5, 10, 25),
    "auto_repair_shop_management": (1, 3, 5, 10, 25),
    "martial_arts_dance_studio_management": (10, 25, 50, 100, 250),
    ...
    "tutoring_center_management": (1, 3, 5, 10, 25),
    "mental_health_therapy_practice_management": (1, 3, 5, 10, 25),
    "physical_therapy_allied_health_practice_management": (1, 3, 5, 10, 25),
    "accounting_firm_practice_management": (1, 3, 5, 10, 25),
    "medical_spa_management": (1, 3, 5, 10, 25),
    "nutrition_dietitian_coaching_practice_management": (1, 3, 5, 10, 25),
    "coaching_practice_management": (10, 25, 50, 100, 250),
    "home_inspection_business_management": (1, 3, 5, 10, 25),
    "notary_signing_business_management": (1, 3, 5, 10, 25),
    "private_investigation_agency_management": (1, 3, 5, 10, 25),
    "bail_bonds_agency_management": (1, 3, 5, 10, 25),
    "electronics_repair_shop_management": (1, 3, 5, 10, 25),
    "pool_service_business_management": (1, 3, 5, 10, 25),
    "event_rental_business_management": (1, 3, 5, 10, 25),
    "moving_company_management": (1, 3, 5, 10, 25),
    "pet_grooming_boarding_management": (1, 3, 5, 10, 25),
    "commercial_cleaning_janitorial_management": (1, 3, 5, 10, 25),
    "handyman_contractor_management": (1, 3, 5, 10, 25),
    "tree_service_arborist_management": (1, 3, 5, 10, 25),
    "pressure_washing_business_management": (1, 3, 5, 10, 25),
    "window_cleaning_business_management": (1, 3, 5, 10, 25),
    "gutter_cleaning_business_management": (1, 3, 5, 10, 25),
    "courier_delivery_dispatch_management": (1, 3, 5, 10, 25),
}
